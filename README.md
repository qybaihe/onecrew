...
7. 点击“导出 OneCrew 工程”下载可再导入的完整 ZIP。包内含项目、剧集、素材实体、分镜、帧提示词、版本化资产和每个媒体文件的 SHA-256。
...
- 创作台已在桌面与 `390 × 844` 移动视口验证，项目切换、剧本/分镜保存、角色/场景/道具编辑、版本资产绑定、版本冲突、画布、导出和成片审阅可用，干净会话浏览器控制台无错误或警告；
